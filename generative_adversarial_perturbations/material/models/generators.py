...
def define(input_nc, output_nc, ngf, gen_type, norm='instance',
    ...
    if gen_type == 'unet':
        ...
        network = RecursiveUnetGenerator(input_nc, output_nc, 8, ngf, norm,
                                         act, use_dropout=False, gpu_ids=gpu_ids)
    elif gen_type == 'resnet':
        network = ResnetGenerator(input_nc, output_nc, ngf, norm, act,
                            use_dropout=True, n_blocks=block, gpu_ids=gpu_ids)
    else:
