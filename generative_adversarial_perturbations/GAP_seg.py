...
from generative_adversarial_perturbations.material.options.train_options \
    import TrainOptions
from generative_adversarial_perturbations.material.data.data_loader \
    import create_data_loader
from generative_adversarial_perturbations.material.models.models \
    import create_seg_model
from generative_adversarial_perturbations.material.utils.visualizer \
    import Visualizer
...
for epoch in tqdm.trange(start_epoch, args.nEpochs):
    ...
    for batch_idx, data in tqdm.tqdm(
        ...
        if args.display_id > 0:
            visualizer.plot_current_errors(epoch, total_iter, args,
                                           errors, 'train')
