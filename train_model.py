...
parser.add_argument('-r', '--resume', default=None, dest='resume', type=str, help='path to resume training')
...
trainer = pl.Trainer(gpus=[args.gpu], checkpoint_callback=checkpoint_callback,
                     logger=wandb_logger, auto_lr_find='lr',
                     resume_from_checkpoint=args.resume)  # allow callback to control validation :)
