...
class AlexNetH(nn.Sequential):
    def __init__(self, underlying=None):
        features = nethook.subsequence(underlying, last_layer='pool5')
        classifier = nethook.subsequence(underlying, after_layer='pool5')
...
class AlexNet(nn.Sequential):
    ...
    def __init__(self, num_classes=None,
            include_lrn=False, split_groups=True,
            include_dropout=False, w=None):
